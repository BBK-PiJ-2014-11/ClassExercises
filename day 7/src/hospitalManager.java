...
public class hospitalManager {
    ...
    public void launch(){
        ...
        patient three = new patient("Harry", 43, "Aml");
        patientListStart.addPatient(three);
        patient four = new patient("Sally", 20, "Sepsis");
        ...
        patient seven = new patient("Anon", 35, "Myeloma");
        patientListStart.addPatient(seven);
        patient eight = new patient("Joe", 9, "Aml");
        patientListStart.addPatient(eight);
        patient nine = new patient("Jane", 16, "Sepsis");
        patientListStart.addPatient(nine);
        patient ten = new patient("Mrs Etc", 60, "Daibetic");
